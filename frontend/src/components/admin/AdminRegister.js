...
function AdminRegister() {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const response = await fetch('/qualified-doctors/admin/register', {
        method: 'POST',
  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        <h2 style={styles.heading}>🛡️ Admin Registration</h2>
        <p style={styles.subheading}>Create your admin account to get started</p>
        ...
        <p style={styles.footer}>
          ...
          <Link to="/qualified-doctors/admin/login" style={styles.link}>Login</Link>
          {' · '}
